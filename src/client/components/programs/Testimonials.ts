    ...
    testimonials: [
      {
        ...
        quote:
          "SASE Interns is a truly flexible program; if I wanted to make an idea come to life, I felt like I always had the support of SASE board and fellow interns to make it happen. It’s an experience that can be whatever you make of it, and for that reason I believe it to be suitable for anyone.",
        image: ConnieHuang,
      },
      {
        name: "Bryant Cao",
