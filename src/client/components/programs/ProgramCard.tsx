      ...
      <OmbreBackground
        innerComponent={
          <div className="h-full w-full">
            <div className="bg-saseGrayLight absolute -left-3 -top-3 z-20 flex h-10 w-14 items-center justify-center rounded-2xl border-l-4 border-t-4 border-border border-saseBlue">
            ...
            <div className="bg-saseGrayLight relative z-10 flex h-full w-full flex-col items-center gap-4 rounded-2xl bg-muted p-6 shadow-saseGreen drop-shadow-[4px_4px_6px_var(--tw-shadow-color)]">
              {/* Image */}
