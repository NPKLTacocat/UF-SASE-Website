import type { ResourceCardProps } from "@/client/components/resources/ResourcesCard";
import ResourceCard from "@/client/components/resources/ResourcesCard";
...
const ClassConnectorForms: React.FC = () => {
  return (
    <div className="w-full px-6 py-8">
      ...
      <p className="mb-6 inline-block pl-6 text-left text-foreground">
