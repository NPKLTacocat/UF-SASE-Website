  ...
  component: () => {
    ...
    return (
      <div className="flex flex-col items-center">
        ...
        <div className="flex w-full flex-col items-center bg-saseGray p-12 dark:bg-background">
        ...
        <div className="flex w-full flex-col items-center justify-center bg-saseGray p-10 dark:bg-background">
